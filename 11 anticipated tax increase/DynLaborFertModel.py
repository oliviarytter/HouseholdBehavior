...
class DynLaborFertModelClass(EconModelClass):
    ...
    def setup(self):
        ...
        par.tau_5plus = 0.0 # change in marginal tax rate from age 5 and onwards.
    ...
    def wage_func(self,capital,t):
        ...
        return (1.0 - tau )* par.w_vec[t] * (1.0 + par.alpha * capital)

    ##############
    # Simulation #
    def simulate(self, reform_age=None, reform_model=None):
        ...
        for i in range(par.simN):
            ...
            for t in range(par.simT):
                ...
                # Switch model solution if after reform age
                if reform_age is not None:
                    if t>=reform_age:
                        sol = reform_model.sol
                    else: 
                        sol = self.sol
