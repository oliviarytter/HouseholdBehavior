...
class DynHouseholdLaborModelClass(EconModelClass):
    ...
    def setup(self):
        ...
        # Joint tax parameters (for joint taxation)
        ...
        # Individual tax parameters (for separate taxation)
    ...
    def tax_func(self,income):
        ...
        if par.joint_tax:
            ...
            rate = 1.0 - par.tax_scale_indiv * (income**(-par.tax_pow_indiv))
        return rate * income
    ...
    def util(self,hours1,hours2,capital1,capital2):
        ...
        # Individual utilities (each member gets cons/2)
        ...
        u1 = util_cons - util_hours1
        u2 = util_cons - util_hours2

        return par.mu * u1 + (1.0 - par.mu) * u2
